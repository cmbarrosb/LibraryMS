...
-- Book Data
INSERT INTO Book (isbn, title, subject, author, description) VALUES
...
-- Copy Data
INSERT INTO Copy (isbn, copy_id, status, location) VALUES
...
-- Loan Data
INSERT INTO Loan (loan_id, member_id, isbn, copy_id, checkout_date, due_date, return_date, overdue_status, staff_id) VALUES
